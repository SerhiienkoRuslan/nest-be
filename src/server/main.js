...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var appOptions, app, options, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appOptions = { cors: true };
                    return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule, appOptions)];
                case 1:
                    app = _a.sent();
                    ...
                    port = parseInt("".concat(process.env.PORT)) || 6000;
